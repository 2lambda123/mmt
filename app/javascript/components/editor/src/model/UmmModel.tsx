...
export default class UmmModel implements FormModel {
  ...
  constructor(schema: any) {
    ...
    makeObservable(this, {
      ...
      visitedSections: observable,
      uiSchema: computed,
      addToVisitedSections: action
    })
  }
  ...
  addToVisitedSections(displayName: string) {
    if (this.visitedSections.length === 0
      || (this.visitedSections.length > 0 && this.visitedSections[this.visitedSections.length - 1] !== displayName)) {
      this.visitedSections.push(displayName)
    }
  }
